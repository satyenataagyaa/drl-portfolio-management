...
def get_model_path(window_length, predictor_type, use_batch_norm):
    ...
    return 'weights/sector/{}/window_{}/{}/checkpoint.ckpt'.format(predictor_type, window_length, batch_norm_str)
...
def get_result_path(window_length, predictor_type, use_batch_norm):
    if use_batch_norm:
        ...
        batch_norm_str = 'no_batch_norm'
    return 'results/sector/{}/window_{}/{}/'.format(predictor_type, window_length, batch_norm_str)
...
if __name__ == '__main__':
    ...
    # setup environment
    env = PortfolioEnv(target_history, target_sectors, steps=1000, window_length=window_length)
